...
int main() {
	...
	cout << "\n\nperson1.birthDate = person2.birthDate: " << boolalpha << (person1.getBirthDate() == person2.getBirthDate()) << "\n\n";
	
	Person person3(111, 1970, 5, 3);
	Person person4 = person3;
	
	cout << "person3.birthDate=" << reinterpret_cast<int> (person3.getBirthDate()) << endl;
	cout << "person4.birthDate=" << reinterpret_cast<int> (person4.getBirthDate()) << endl;
